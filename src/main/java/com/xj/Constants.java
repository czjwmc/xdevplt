...
public final class Constants {
    ...
    //add by wmc 2013/09/22
    /**
     * The name of the available XdpGroups list, a request-scoped attribute
     * when adding/editing a user.
     */
    public static final String AVAILABLE_XDPGROUPS = "availableXdpGroups";
    
    /**
     * The name of the SDPPATH, a request-scoped attribute
     * when Uploading or downloading a file.
     */    
    public static final String SDPPATH = "SDP0000";
