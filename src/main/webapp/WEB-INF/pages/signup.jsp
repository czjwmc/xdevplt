...
<div class="span7">
    <s:form name="signupForm" action="saveSignup" method="post" validate="true"
        ...
        <%-- <s:textfield key="user.passwordHint" required="true"/> --%> <%-- Modified by wx Ver0.0.1. --%>
        <s:textfield key="user.passwordHint"/>
        <s:textfield key="user.firstName" required="true"/>
        <s:textfield key="user.lastName" required="true"/>
        <%-- <s:textfield key="user.email" required="true"/> --%> <%-- Modified by wx Ver0.0.1. --%>
